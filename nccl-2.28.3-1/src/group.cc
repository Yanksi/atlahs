...
static nvtxEventAttributes_t eventAttrib_groupstart = {0};
static nvtxEventAttributes_t eventAttrib_groupend   = {0};
static nvtxEventAttributes_t eventAttrib_group      = {0};
#endif
          ...
          if (plan != nullptr) {
            ...
            #if defined(ENABLE_API_NVTX)
            {
              ...
              snprintf(nvtxMsg_Group, sizeof(nvtxMsg_Group),
                      "ncclLaunchKernel(): pid %d", (int)pid);
